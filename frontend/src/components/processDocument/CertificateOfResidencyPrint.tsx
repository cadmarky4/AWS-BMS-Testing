...
const CertificateHeader: React.FC = () => (
  <div className="text-center mb-8">
    <div className="mb-4">
      ...
      <h4 className="text-lg font-bold text-gray-800">Brgy. West Triangle</h4>
    </div>
...
const CertificateOfResidencyPrint: React.FC = () => {
  ...
  const applicantAddress = document.applicant_address || 
    ...
    'Brgy. West Triangle, Samal, Bataan';
          ...
          <div className="bg-white p-8 shadow-lg print:shadow-none print:p-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-base leading-relaxed text-justify">
                ...
                <span className="font-semibold">{new Date().getFullYear()}</span> at Brgy. West Triangle, Samal, Bataan, Philippines.
              </p>
            </div>
